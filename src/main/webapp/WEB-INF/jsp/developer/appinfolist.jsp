...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					APP 信息管理维护 <i class="fa fa-user"></i><small>${devLoginUser.devName}
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/dev/app/appinfoadd" class="btn btn-success btn-sm">新增APP基础信息</a>
				...
				<div class="row">
					<c:if test="${appInfoList.totalCount gt 0}">
						<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							role="status" aria-live="polite">共${appInfoList.totalCount }条记录
							${appInfoList.pageIndex }/${appInfoList.pageTotalCount }页</div>
					</div>
					<div class="col-sm-7">
						<div class="dataTables_paginate paging_simple_numbers"
							id="datatable-responsive_paginate">
							<ul class="pagination">
								<c:if test="${appInfoList.pageIndex > 1}">
									...
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${appInfoList.pageIndex-1});"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">上一页</a>
									</li>
								</c:if>
								<c:if test="${appInfoList.pageIndex < appInfoList.pageTotalCount }">
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${appInfoList.pageIndex+1 });"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">下一页</a>
									...
									<li class="paginate_button next"><a
										href="javascript:page_nav(document.forms[0],${appInfoList.pageTotalCount });"
